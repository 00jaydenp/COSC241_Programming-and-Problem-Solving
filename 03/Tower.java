...
public class Tower{
     ...
     * @return int (number of blocks in tower)
     */
    public int height(){
        if (isEmpty()){
            return 0;
    ...
    /** Counts the amount of occurences of a block in the tower.
        @param c (what to check for in tower)
        @return int (number of occurences of c in the tower
    */
